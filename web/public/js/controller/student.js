var controllerStudent = function () {
    $('#section').addClass('active');
};

/*************************************CRUD**************************************************/
controllerStudent.prototype.addEditProcessing = function () {
    var that = this;
...
controllerStudent.prototype.deleteProcess = function () {
    var that = this;
    $('body').on('click', '.ajaxDelete', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: Routing.generate("app_student_delete", {"id": $(this).attr('data-id')})
        })
            .done(function (resp) {
...
controllerStudent.prototype.newDisplay = function () {
    $('body').on('click', '#user-add-modal', function (e) {
        e.preventDefault();
        $.ajax({
            type: "GET",
            url: Routing.generate("app_student_create")
        })
            .done(function (resp) {
...
controllerStudent.prototype.editDisplay = function () {
    var that = this;
    $('body').on('click', '.ajaxEdit', function (e) {
        e.preventDefault();
        $.ajax({
            type: "GET",
            url: Routing.generate("app_student_edit", {"id": $(this).attr('data-id')})
        })
            .done(function (resp) {
                $("#crudModal").replaceWith(resp.form);
                $("#crudModal").modal();
...
controllerStudent.prototype.init = function () {
...
$(function () {
    var controller = new controllerStudent();
    controller.init();
});